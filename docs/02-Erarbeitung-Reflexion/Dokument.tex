...
\section{Implementierung}
    ...
    Sind Kubernetes-Cluster, Kubectl und Helm eingerichtet, lässt sich die gesamte Software mit einem Befehl mit dem Repository-Root als Arbeitsverzeichnis wie folgt ausrollen.
    Der Befehl zur Installation sieht wie folgt aus:\\
