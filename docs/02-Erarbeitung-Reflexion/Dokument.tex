...
\section{Implementierung}
    ...
    \end{lstlisting} %my-release nochmal umbenennen
...
%   - Falls mehr Details erwünscht sind, dann auch mehr auf den Code, die Topics und den Aufbau des Helm-Charts eingehen
