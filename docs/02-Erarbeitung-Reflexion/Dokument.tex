...
\section{Implementierung}
    ...
    Die Kommunikation zwischen den Microservices erfolgt verschlüsselt, und rollenbasierte Zugriffskontrollen (RBAC) stellen sicher, dass nur autorisierte Entitäten Zugriff auf die Daten haben. %Nochmal erläutern und ggf. verfizieren
    Zudem werden alle Datenflüsse umfassend dokumentiert, um den Richtlinien der Datenschutz-Grundverordnung (DSGVO) zu entsprechen. % Evtl einfach einen Microservice für DSGVO Themen bauen
